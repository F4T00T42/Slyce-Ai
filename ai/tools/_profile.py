...
PROFILE_ARG_SCHEMA = {
    ...
    "properties": {
        "weight": {"type": "string", "description": "Body weight in kg, e.g. \"70\"."},
        "height": {"type": "string", "description": "Height in cm, e.g. \"175\"."},
        "age": {"type": "string", "description": "Age in years, e.g. \"30\"."},
